...
ThemeData workspaceTheme() => ThemeData(
  ...
  appBarTheme: const AppBarTheme(
    ...
    foregroundColor: Color(0xff18252c),
    elevation: 0,
  ...
  cardTheme: const CardThemeData(
    ...
    shape: RoundedRectangleBorder(
      borderRadius: BorderRadius.all(Radius.circular(6)),
      side: BorderSide(color: Color(0xffdce4e8)),
    ),
  ),
...
Color priorityColor(String priority) => switch (priority) {
  'critical' => const Color(0xffb42336),
  'high' => const Color(0xff99610a),
  _ => const Color(0xff26735e),
};
